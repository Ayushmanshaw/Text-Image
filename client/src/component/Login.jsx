...
const Login = () => {
  ...
  const onSubmitHandler = async (e) => {
    e.preventDefault();
    console.log("Form Submitted", { email, password }); // ✅ Debugging line
...
//correct code
  ...
  //     const data = response.data; // ✅ Now data is properly assigned
  
  //     if (data.success) {
  //       setToken(data.token);
  //       setUser(data.user);
  //       localStorage.setItem("token", data.token); // ✅ Fixed localStorage issue
  //       setShowLogin(false);
  //     } else {
  //       toast.error(data.message);
  //     }
